...
#define RULE1_WEIGHT           (2/8)  // Weight of aggregation rule (default 0.6/10)
#define RULE2_WEIGHT           (0.02/10) // Weight of dispersion rule (default 0.02/10)
#define RULE3_WEIGHT           (1.0/10)  // Weight of consistency rule (default 1.0/10)
#define MIGRATION_WEIGHT       (0.05/10) // Weight of attraction towards the common goal (default 0.02/10)
...
static const float e_puck_matrix[16] = { 20, 10, 5,  0,  0, -5,-10,-20,  -20,-10,-5,  0, 0, 5, 10, 20}; // Maze
